...
public class AccountService {
    ...
    public AccountService(AccountRepository accountRepository, MembershipRepository membershipRepository) {
    ...
    private AccountSummaryResponse toAccountSummary(Account account, Membership membership, UUID currentAccountId) {
