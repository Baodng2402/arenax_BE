...
public class UserRegisteredEventConsumer {
    ...
    public void onUserRegistered(@Payload String payload) throws JsonProcessingException {
        EventEnvelope<UserRegisteredPayload> envelope = objectMapper.readValue(
                payload,
                objectMapper.getTypeFactory().constructParametricType(EventEnvelope.class, UserRegisteredPayload.class));
