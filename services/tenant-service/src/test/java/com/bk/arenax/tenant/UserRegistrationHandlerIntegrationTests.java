...
class UserRegistrationHandlerIntegrationTests {
  ...
  @Autowired private UserRegistrationHandler userRegistrationHandler;
  ...
  void handleCreatesPersonalAccountAndOwnerMembership() {
    ...
    assertThat(outboxEvents.getFirst().getEventType())
        .isEqualTo("tenant.personal-account-created.v1");
  ...
  private EventEnvelope<UserRegisteredPayload> userRegisteredEvent(
