...
public class PasswordResetService {
  ...
  public void requestPasswordReset(String email) {
    findVerifiedEmailIdentifier(emailNormalizationService.normalize(email))
        .ifPresent(
            identifier -> {
              User user =
                  userRepo
  ...
  public void resetPassword(String rawToken, String newPassword) {
    ...
    User user =
        userRepo
            ...
            .orElseThrow(
                () -> new IllegalStateException("User not found for password reset token"));
    token.consume(now);
