...
public class GatewayRouteConfiguration {
  ...
  RouterFunction<ServerResponse> gatewayRoutes(
      GatewayRoutesProperties routesProperties, GatewayHeaderFilter gatewayHeaderFilter) {
