...
public class GatewayHeaderFilter {
  ...
  private static final List<String> TRUSTED_IDENTITY_HEADERS =
      List.of(
          "X-Arenax-User-Id",
          "X-Arenax-Session-Id",
          "X-Arenax-Account-Id",
      ...
      if (authentication instanceof JwtAuthenticationToken jwtAuthenticationToken) {
        builder.headers(
            headers -> {
              ...
              headers.set(
                  "X-Arenax-Session-Id", jwtAuthenticationToken.getToken().getClaimAsString("sid"));
  ...
  private static void setClaimHeader(
      HttpHeaders headers, Jwt token, String claim, String headerName) {
