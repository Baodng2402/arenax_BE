...
class PersonalAccountCreatedHandlerIntegrationTests {
  ...
  @Autowired private PersonalAccountCreatedHandler handler;
  ...
  void handleIsIdempotentForDuplicateEventDelivery() {
    EventEnvelope<PersonalAccountCreatedPayload> event =
        personalAccountCreatedEvent(
            UUID.fromString("66666666-6666-6666-6666-666666666666"), "Player Two");
  ...
  private EventEnvelope<PersonalAccountCreatedPayload> personalAccountCreatedEvent(
    ...
    return new EventEnvelope<>(
        ...
        new PersonalAccountCreatedPayload(
            UUID.fromString("77777777-7777-7777-7777-777777777777"), accountId, accountName));
  }
}
