...
public class PersonalAccountCreatedEventConsumer {
    ...
    public PersonalAccountCreatedEventConsumer(PersonalAccountCreatedHandler handler, ObjectMapper objectMapper) {
    ...
    public void onPersonalAccountCreated(@Payload String payload) throws JsonProcessingException {
        EventEnvelope<PersonalAccountCreatedPayload> envelope = objectMapper.readValue(
                payload,
                objectMapper.getTypeFactory().constructParametricType(
                        EventEnvelope.class, PersonalAccountCreatedPayload.class));
